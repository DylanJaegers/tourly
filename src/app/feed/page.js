...
export default function FeedPage() {
  ...
  return (
    <div className="h-screen bg-black overflow-hidden flex" onKeyDown={handleKeyDown} tabIndex={0}>
      ...
      <div className="hidden md:flex flex-col w-52 bg-zinc-950 border-r border-zinc-800 flex-shrink-0">
        ...
        <div className="flex-1 px-3 py-4 flex flex-col gap-1 overflow-y-auto">
          ...
          <button onClick={() => setActiveTab('all')}
            className={'flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm transition w-full text-left ' + (activeTab === 'all' ? 'bg-white text-black font-semibold' : 'text-zinc-300 hover:bg-zinc-800 hover:text-white')}>
